        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 sm:gap-4 text-[11px] sm:text-xs">
            ...
            <a 
              ...
              className="hidden sm:flex items-center gap-1.5 text-cafe-300 hover:text-amberGold transition-colors"
              title="Email Social Sips Cafe"
            >
              <Mail className="w-3 h-3 text-amberGold" />
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            {navLinks.map((link) => (
              <button
                ...
                className="text-xs lg:text-sm font-bold text-cafe-800 hover:text-amberGold transition-colors cursor-pointer py-1 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-amberGold hover:after:w-full after:transition-all after:duration-200"
              >
                {link.name}
              </button>
            ))}
          ...
          <div className="hidden sm:flex items-center gap-3">
            <a
              href="tel:+17272401811"
              className="px-3.5 py-2 rounded-xl border border-cafe-300 bg-white hover:bg-cafe-50 text-cafe-900 text-xs font-bold transition-all shadow-xs flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-cafe-900 hover:bg-cafe-800 text-white font-bold text-xs shadow-warm-sm hover:shadow-warm-md transition-all duration-300 flex items-center gap-1.5 group cursor-pointer"
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-cafe-200/90 bg-cream/98 backdrop-blur-xl px-4 pt-3 pb-6 shadow-warm-lg">
