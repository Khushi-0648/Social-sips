  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        {/* Minimal Subtle Edge Vignettes: Keep 80% of Video Untinted & Crystal Clear */}
        <div className="absolute top-0 left-0 right-0 h-36 bg-gradient-to-b from-black/50 via-black/15 to-transparent pointer-events-none" />
        <div className="absolute bottom-0 left-0 right-0 h-44 bg-gradient-to-t from-black/55 via-black/15 to-transparent pointer-events-none" />
      </div>
