            ...
            >
              ...
              <div className="relative h-56 overflow-hidden bg-cafe-100">
                ...
                <div className="absolute top-3 left-3 flex flex-col gap-1.5">
                  <span className="px-3 py-1 rounded-full bg-cafe-900/85 text-amberGold text-xs font-bold backdrop-blur-md border border-amberGold/30">
                    {item.badge}
                  </span>
                </div>
              </div>
